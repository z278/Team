 ...
 * @author hp
 */
public class RecordsQuery extends ActionSupport{
    ...
    public String execute() throws Exception{
        ...
        list=recordDao.queryInfo("account_number", this.account_number);
        request.getSession().setAttribute("recordlook", list);
        return mess;
    }
}
