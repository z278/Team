<%-- 
    Document   : register_teller
    Created on : 2020-5-13, 17:53:22
    Author     : hp
--%>
...
<html>
    ...
    <body>
        <form name="form13" action="register_teller" method="post">
            <table name="table13" align="center" cellpadding="0.5">
                <tr>
                    <td>
