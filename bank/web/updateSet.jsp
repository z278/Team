<%-- 
    Document   : updateSet
    Created on : 2020-4-22, 14:00:33
    Author     : gai'shi'ying'xiong
--%>
...
<html>
    ...
    <body background="背景5.jpg" style="background-size:100%">
        ...
        <s:form action="updateSetAction" method="post">
            <table align="center" width="30%" border="5">
                ...
                %>
                    ...
                    <tr>
                        <td>
                            <font face="楷体,宋体" size="4" align="center">存款数额</font>
                        </td>
                        <td>
                            <input type="text" name="getMoney" value="${setMoney}">
                        </td>
                    </tr>
                    <tr>
                        <td>
