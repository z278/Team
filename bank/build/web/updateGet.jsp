    ...
    <body background="背景5.jpg" style="background-size:100%">
        ...
        <table align="center" width="80%">
            <tr>
                ...
                <td width="20%">
                    <font face="楷体,宋体" size="4" align="center">取款</font>
                </td>
                <td width="20%">
        ...
        <br/><br/><br/>
        <center><font face="楷体,宋体" size="5" align="center">取款</font></center>
        </div>
        <s:form action="updateGetAction" method="post">
            <table align="center" width="30%" border="5">
                ...
                %>
                    ...
                    <tr>
                        <td>
                            <font face="楷体,宋体" size="4" align="center">取款数额</font>
                        </td>
                        <td>
                            <input type="text" name="getMoney" value="${getMoney}">
                        </td>
                    </tr>
                    <tr>
                        <td>
